<?php
  ...
  echo "The " . $bird1->commonName; " eats " . $bird1->food . ".</ br> It Nests on " . $bird1->nestPlacement . " and its conservation level is " . $bird1->conservationLevel .".";
  echo "The " . $bird2->commonName; " eats " . $bird2->food . ".</ br> It Nests on " . $bird2->nestPlacement . " and its conservation level is " . $bird2->conservationLevel .".";
?>